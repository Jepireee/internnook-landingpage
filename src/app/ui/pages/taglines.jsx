    ...
    <>
      ...
      <section className="flex flex-col md:flex-row-reverse items-center justify-center gap-12 px-6 sm:px-12 md:px-20 py-25 bg-[#FFFFFF] relative">
        ...
        <div className=" p-6 lg:p-10  max-w-md">
          <h2
            className={`${anton.className} text-7xl font-bold text-[#FD7201] mt-2 italic text-right`}
          >
            Where Dream Jobs Take Root!
          </h2>
          <p className={`${poppins.className} text-gray-700 text-right mt-10`}>
            Internook helps students build a strong foundation for their future
            careers by connecting them with the right internship opportunities
            to grow and succeed.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center gap-8 px-6 py-12 bg-[#FFFFFF] relative">
        ...
        <div className="p-6 lg:p-10  max-w-md">
          <h2
            className={`${anton.className} text-7xl font-bold text-[#FD7201] mt-2 italic text-left`}
          >
            The Smart Way To Look!
          </h2>
          <p className={`${poppins.className} text-gray-700 text-left mt-10`}>
