...
export default function SuggestionPage (){
    ...
    return (
        <section id="suggestionPage" className="flex flex-col md:flex-row items-center justify-center gap-8 px-6 py-12 bg-[#FFFFFF] relative">
            <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div className="text-center lg:text-left">
                    ...
                    >
                        ...
                        <button
                        type="submit"
                        className="px-6 py-2 mt-5 bg-[#135C9F] text-white px-4 py-3 rounded-md text-sm font-medium shadow-md hover:bg-blue-700 cursor-pointer"
                        >
                        Submit
                        </button>
                    </form>
